...
$query = "select * from employees7 where id='$id'";
...
{
   $query = "delete from employees7 where id='".$_POST['confirmdelete']."'";
...
{
   $query = "update employees7 set first='".$_POST['first']."', last='".$_POST['last']."', phone='".$_POST['phone']."', email='".$_POST['email']."', expertise='".$_POST['expertise']."' where id='".$_POST['confirmupdate']."';";
   mysqli_query($conn, $query);
   header("location: admin.php");
}
...
{
   $query = "select * from employees7 where id='".$_POST['id']."'";
   $result = mysqli_query($conn, $query);
