...
$query = "select * from employees9 where id='$id'";
...
if (isset($_POST['details']))
{
   ...
   $joinQuery = "select * from access9 inner join approvedaccess9 on (access9.id = approvedaccess9.item_id) where emp_id='".$output['id']."';";
...
{
   $query = "delete from employees9 where id='".$_POST['confirmdelete']."'";
...
{
   $query = "update employees9 set first='".$_POST['first']."', last='".$_POST['last']."', phone='".$_POST['phone']."', email='".$_POST['email']."', expertise='".$_POST['expertise']."' where id='".$_POST['confirmupdate']."';";
   mysqli_query($conn, $query);
   header("location: admin.php");
}
...
{
   $query = "select * from employees9 where id='".$_POST['id']."'";
   $result = mysqli_query($conn, $query);
